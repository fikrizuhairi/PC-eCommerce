...
<?php
	if(isset($_POST['submit']))
	{
		...
		echo"<script type='text/javascript'>
		 ...
		 echo "<meta http-equiv=\"refresh\" content=\"0; URL=updateSoftware.php\">";
	}
...
?>
		<div class="row">
           ...
           <a href="updateSoftware.php"><button type="button" id="cancel" name="cancel" class="btn btn-danger loginFormElement">Cancel</button></a></center>
				<br>
			</div></form>
