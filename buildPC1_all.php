 <?php
		...
		if($_SESSION['ic'] == "")
		{
			...
			$sqlBudget="SELECT product_id,product_type,image_name,product_price,product_name from product where product_price <='".$_GET['budget']."' and product_availability = '1' and product_quantity != '0' order by product_type asc, product_price asc";
			...
			<div class="table-responsive shopping-cart-table">
				...
				<table class="table table-bordered" >
                    ...
                    <?php
						...
						{
					?>
                    <form action="buildPC1_all.php?id=<?php echo $resultBudget['product_id'] ?>&amount=<?php echo $resultBudget['product_price'];?>&budget=<?php echo $_GET['budget'] ?>" method="post">
						<tr>
