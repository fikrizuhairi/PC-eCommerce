			...
			<div class="w3ls_mobiles_grids">
                ...
                <div class="col-md-10">
                    <ul class="nav nav-pills nav-stacked" style="background-color: #ffffff; border:0.5px solid #bdc3c7; box-shadow: 5px 5px 5px 2px gray;">
                        ...
                        <li class="active"><a href="shopKeyboard.php">&nbsp;&nbsp;Keyboard</a></li>
	...
	<!--- Side Bar --->
			<?php
				...
				<div class="col-md-8 w3ls_mobiles_grid_right">
					...
					<?php
						$sqlSelect="SELECT * FROM product where product_type='Keyboard' AND product_availability = '1' order by product_price asc";
