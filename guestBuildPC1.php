 <?php
		...
		include_once('connectdb.php');
			...
			$sqlBudget="SELECT product_id,product_type,image_name,product_price,product_name from product where product_price <='".$_POST['txtBudget']."' and product_availability = '1' and product_quantity != '0' order by product_type asc, product_price asc";
...
<center><h1><i class="fa fa-desktop" aria-hidden="true"></i> Easy PCTech</h1></center>
	...
	<div class="row cart-head">
				...
				<br>
                 ...
                 <select class="form-control" style="width:40%" onChange="Site(this.value)">
                 	<option value="">*--- Choose PC for ---*</option>
                    <option value="guestBuildPC1_all.php?budget=<?php echo $_POST['txtBudget'] ?>">All</option>
                    <option value="guestBuildPC1_pcGaming.php?budget=<?php echo $_POST['txtBudget'] ?>">PC Gaming</option>
                    <option value="guestBuildPC1_office.php?budget=<?php echo $_POST['txtBudget'] ?>">Office</option>
                    <option value="guestBuildPC1_personalUses.php?budget=<?php echo $_POST['txtBudget'] ?>">Personal Uses</option>
                 </select>
	...
	<br><br>
            ...
            <form action="addCartbuildPc.php" method="post">
				<table class="table table-bordered" >
					...
					?>
						<tr>
							...
							<td class="text-center">
								<button type="submit" title="Add" class="btn btn-default tool-tip">
