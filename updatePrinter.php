...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Printer</h1>
			</div>
		</div><!--/.row-->
			<div class="row" >
              ...
              <div class="col-sm-12">
              <?php
                    $sqlSelect="SELECT * FROM product WHERE product_type = 'Printer'";
              ...
              <center><img src='imgProduct/<?php echo $resultSelect['image_name'];?>' File WIDTH=120 HEIGHT=160/></center>
			   ...
			   <a href="updatePrinter1.php?product_id=<?php echo $resultSelect['product_id'];?>"><button type="button" id="updateProduct" name="submit" class="btn btn-primary loginFormElement">Update</button></a>
