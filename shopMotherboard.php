...
<center><h1><i class="fa fa-desktop" aria-hidden="true"></i> Easy PCTech</h1></center>
			...
			<div class="w3ls_mobiles_grids">
                ...
                <div class="col-md-10">
                    <ul class="nav nav-pills nav-stacked" style="background-color: #ffffff; border:0.5px solid #bdc3c7; box-shadow: 5px 5px 5px 2px gray;">
                        ...
                        <li class="active"><a href="shopMotherboard.php">&nbsp;&nbsp;Motherboard</a></li>
	...
	<!--- Side Bar --->
				<?php
					...
					{
						$sqlProduct="SELECT product_id, no_ic FROM cart where product_id='".$_POST['id']."' and payment_id is null";
						$queryProduct=mysqli_query($con,$sqlProduct) or die (mysqli_error($con));
						$resutProduct=mysqli_fetch_row($queryProduct);
						if($resutProduct == 0)
						{
							
							$sql="INSERT INTO cart(cart_id,no_ic,product_id,quantity,subtotal) VALUES ('','".$_SESSION['ic']."','".$_POST['id']."','1','".$_POST['amount']."')";
				...
				<div class="col-md-8 w3ls_mobiles_grid_right">
					...
					<?php
						$sqlSelect="SELECT * FROM product where product_type='Motherboard' AND product_availability = '1' order by product_price asc";
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group" >
                                            <div class="container1">
                                                ...
                                                <div class="middle">
                                                    <div class="text"><a href="shopping1.php?id=<?php echo $resultSelect['product_id'];?>"><?php echo $resultSelect['product_name'];?></a></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
