	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
                ...
                <li><a href="updatePowerSupply.php">
					Power Supply
				</a></li>
...
<?php
	if(isset($_POST['submit']))
	{
		...
		echo"<script type='text/javascript'>
		 ...
		 echo "<meta http-equiv=\"refresh\" content=\"0; URL=updatePowerSupply.php\">";
	}
...
?>
		<div class="row">
           ...
           <a href="updatePowerSupply.php"><button type="button" id="cancel" name="cancel" class="btn btn-danger loginFormElement">Cancel</button></a></center>
				<br>
			</div></form>
