 <?php
		...
		if($_SESSION['ic'] == "")
		{
			...
			$sqlBudget="SELECT product_id,product_type,image_name,product_price,product_name from product where product_price <='".$_GET['budget']."' and product_availability = '1' and product_quantity != '0' and pc_gaming='1' order by product_type asc, product_price asc";
			 ...
			 <div class="navbar-header">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
					    ...
					    <li style="background-color:#4B77BE;"><a href="buildPC.php">Build Your PC</a></li>
	...
	<div class="row cart-head">
				...
				<br>
                 ...
                 <select class="form-control" style="width:40%" onChange="Site(this.value)">
                    ...
                    <option value="buildPC1_all.php?budget=<?php echo $_GET['budget'] ?>">All</option>
                    <option value="buildPC1_pcGaming.php?budget=<?php echo $_GET['budget'] ?>">PC Gaming</option>
                    <option value="buildPC1_office.php?budget=<?php echo $_GET['budget'] ?>">Office</option>
                    <option value="buildPC1_personalUses.php?budget=<?php echo $_GET['budget'] ?>">Personal Uses</option>
                 </select>
			...
			<div class="table-responsive shopping-cart-table">
				...
				<table class="table table-bordered" >
                    ...
                    <?php
						...
						{
					?>
                    <form action="buildPC1_pcGaming.php?id=<?php echo $resultBudget['product_id'] ?>&amount=<?php echo $resultBudget['product_price'];?>&budget=<?php echo $_GET['budget'] ?>" method="post">
						<tr>
